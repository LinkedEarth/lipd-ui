import { ArchiveType, PaleoProxy, PaleoProxyGeneral, InterpretationVariable, InterpretationSeasonality, PaleoUnit, PaleoVariable, SYNONYMS, Location, Person, Publication, Change, ChangeLog, Funding, Interpretation, Calibration, Resolution, Compilation, Variable, DataTable, Model, PaleoData, Dataset } from 'lipdjs';
...
import { Box, Typography, Link, TextField, IconButton, Button, Grid, MenuItem, CircularProgress, Divider, List, ListItem, ListItemText, ListItemIcon } from '@mui/material';
...
import { TreeItem as TreeItem$1 } from '@mui/x-tree-view/TreeItem';
...
var useLiPDStore = create((set, get) => ({
  dataset: null,
  isLoading: false,
  isSaving: false,
  isSyncing: false,
...
var ArrowBackIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20z" })
  );
};
var NavigateNextIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" })
  );
};
var HomeIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" })
  );
};
var SaveIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M17 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V7l-4-4zm-5 16c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm3-10H5V5h10v4z" })
  );
};
var SaveAsIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M12 3L12 16" }),
    /* @__PURE__ */ React.createElement("path", { d: "M7 11L12 16L17 11" }),
    /* @__PURE__ */ React.createElement("path", { d: "M4 18L4 20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22L18 22C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20L20 18" })
  );
};
var UndoIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M12.5 8c-2.65 0-5.05.99-6.9 2.6L2 7v9h9l-3.62-3.62c1.39-1.16 3.16-1.88 5.12-1.88 3.54 0 6.55 2.31 7.6 5.5l2.37-.78C21.08 11.03 17.15 8 12.5 8z" })
  );
};
var RedoIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M18.4 10.6C16.55 8.99 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 15.5c1.05-3.19 4.05-5.5 7.6-5.5 1.95 0 3.73.72 5.12 1.88L13 15h9V6l-3.6 4.6z" })
  );
};
var SyncIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z" })
  );
};
var AddIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" })
  );
};
var EditIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" })
  );
};
var DeleteIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z" })
  );
};
var ExpandMoreIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z" })
  );
};
...
var DescriptionIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z" })
  );
};
var TableChartIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M10 10.02h5V21h-5zM17 21h3c1.1 0 2-.9 2-2v-9h-5v11zm3-18H5c-1.1 0-2 .9-2 2v3h19V5c0-1.1-.9-2-2-2zM3 19c0 1.1.9 2 2 2h3V10H3v9z" })
  );
};
var FolderIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M10 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2h-8l-2-2z" })
  );
};
var ArticleIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z" })
  );
};
var TableRowsIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M21 8c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1s.45 1 1 1h16c.55 0 1-.45 1-1zM4 13h16c.55 0 1-.45 1-1s-.45-1-1-1H4c-.55 0-1 .45-1 1s.45 1 1 1zm16 2H4c-.55 0-1 .45-1 1s.45 1 1 1h16c.55 0 1-.45 1-1s-.45-1-1-1z" })
  );
};
var CheckIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" })
  );
};
var FileUploadIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zm-3-7l-4-4-4 4h3v4h2v-4h3z" })
  );
};
var FileDownloadIcon = ({ fontSize = "medium", sx, style, ...props }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z" })
  );
};
...
var AppBarActions = () => {
  ...
  return /* @__PURE__ */ React.createElement(Box$1, { sx: { display: "flex", alignItems: "center" } }, /* @__PURE__ */ React.createElement(Box$1, { sx: { display: "flex", mr: 2 } }, /* @__PURE__ */ React.createElement(Tooltip, { title: "Undo (VS Code Cmd+Z / Ctrl+Z)" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(
    IconButton$1,
    {
      onClick: undo,
    ...
    /* @__PURE__ */ React.createElement(UndoIcon, { fontSize: "small" })
  ))), /* @__PURE__ */ React.createElement(Tooltip, { title: "Redo (VS Code Cmd+Shift+Z / Ctrl+Y)" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(
    IconButton$1,
    {
      onClick: redo,
    ...
    /* @__PURE__ */ React.createElement(RedoIcon, { fontSize: "small" })
  )))), /* @__PURE__ */ React.createElement(Divider$1, { orientation: "vertical", flexItem: true, sx: { mx: 1 } }), /* @__PURE__ */ React.createElement(Box$1, { sx: { display: "flex", alignItems: "center", ml: 1 } }, /* @__PURE__ */ React.createElement(Tooltip, { title: "Save (VS Code Cmd+S / Ctrl+S)" }, /* @__PURE__ */ React.createElement(
    IconButton$1,
    {
      onClick: saveDataset,
      disabled: isSaving,
    ...
    /* @__PURE__ */ React.createElement(SaveIcon, { fontSize: "small" })
  )), /* @__PURE__ */ React.createElement(Tooltip, { title: "Save As (VS Code Cmd+Shift+S / Ctrl+Shift+S)" }, /* @__PURE__ */ React.createElement(
    IconButton$1,
    {
    ...
    /* @__PURE__ */ React.createElement(SaveAsIcon, { fontSize: "small" })
  )), /* @__PURE__ */ React.createElement(Tooltip, { title: "Sync to GraphDB" }, /* @__PURE__ */ React.createElement(
    IconButton$1,
    {
      onClick: syncDataset,
      disabled: isSyncing,
    ...
    /* @__PURE__ */ React.createElement(SyncIcon, { fontSize: "small" })
  ))));
};
var AppBarActions_default = AppBarActions;
var Fieldset = ({ children, dense = false }) => /* @__PURE__ */ React.createElement(
  Box,
  {
    component: "fieldset",
    sx: {
...
var ListView = ({
  ...
  const content = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(List, { dense, sx: { width: "100%", p: 0 } }, (items || []).map((item, index) => {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, { key: index }, index > 0 && /* @__PURE__ */ React.createElement(Divider, null), /* @__PURE__ */ React.createElement(
      ListItem,
      {
        ...
        secondaryAction: !readonly ? /* @__PURE__ */ React.createElement(Box, { sx: { display: "flex" } }, editIndex === index ? /* @__PURE__ */ React.createElement(
          IconButton,
          {
            edge: "end",
            "aria-label": "save",
          ...
          /* @__PURE__ */ React.createElement(CheckIcon, { sx: { fontSize: dense ? 16 : 24 } })
        ) : isSimpleValue ? /* @__PURE__ */ React.createElement(
          IconButton,
          {
            edge: "end",
            "aria-label": "edit",
          ...
          /* @__PURE__ */ React.createElement(EditIcon, { sx: { fontSize: dense ? 16 : 24 } })
          ...
          /* @__PURE__ */ React.createElement(DeleteIcon, { sx: { fontSize: dense ? 16 : 24 } })
        )) : null
      },
  ...
  }), !readonly && addingNew && /* @__PURE__ */ React.createElement(ListItem, null, /* @__PURE__ */ React.createElement(
    TextField,
    {
      value: newItemValue,
      ...
      InputProps: {
        endAdornment: /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(CheckIcon, { fontSize: "small" })
        )
      }
    }
  ))));
  if (useFieldset) {
    return /* @__PURE__ */ React.createElement(Fieldset, { dense }, /* @__PURE__ */ React.createElement("legend", null, title, !readonly && /* @__PURE__ */ React.createElement(
      Button,
      {
...
var FormTextField = React.memo(({
  ...
  if (disabled) {
    if (value === void 0 || value === null || value.toString().trim() === "")
      return null;
    return /* @__PURE__ */ React.createElement(Box, { sx: { py: 0.5 } }, /* @__PURE__ */ React.createElement(Typography, { variant: "caption", color: "text.secondary", sx: { mr: 1 } }, label, ":"), typeof value === "string" && value.match(/^https?:\/\//) ? /* @__PURE__ */ React.createElement(Link, { href: value, target: "_blank", rel: "noopener noreferrer" }, value) : /* @__PURE__ */ React.createElement(Typography, { component: "span" }, value));
  }
  return /* @__PURE__ */ React.createElement(FormControl, { variant: formVariant, sx: { mt: 1, width: "100%" } }, /* @__PURE__ */ React.createElement(
    TextField,
    {
      inputRef,
      label,
...
var DataTableEditor = ({ path, params, onUpdate, title = "", readonly = false }) => {
  ...
  const gridColumns = [
    ...
    ...readonly ? [] : [{
      ...
      headerName: "Actions",
      width: 120,
      renderCell: (params2) => /* @__PURE__ */ React.createElement(Box, null, /* @__PURE__ */ React.createElement(
        IconButton,
        {
          size: "small",
          edge: "end",
        ...
        /* @__PURE__ */ React.createElement(DeleteIcon, { sx: { fontSize: 16 } })
      ))
    }]
  ];
  ...
  return /* @__PURE__ */ React.createElement(Box, { sx: { p: 0 } }, /* @__PURE__ */ React.createElement(Box, { sx: { display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 } }, /* @__PURE__ */ React.createElement(Typography, { variant: "h6" }, title), !readonly && /* @__PURE__ */ React.createElement(Box, { sx: { display: "flex", gap: 1 } }, /* @__PURE__ */ React.createElement(
    Button,
    {
      variant: "contained",
      startIcon: /* @__PURE__ */ React.createElement(FileUploadIcon, null),
      size: "small",
      component: "label"
    },
    "Import CSV",
    ...
    {
      variant: "contained",
      startIcon: /* @__PURE__ */ React.createElement(FileDownloadIcon, null),
      size: "small",
    ...
    {
      variant: "contained",
      startIcon: /* @__PURE__ */ React.createElement(AddIcon, { sx: { fontSize: 18 } }),
      size: "small",
      onClick: handleAddRow
    },
    "Add Row"
  ))), /* @__PURE__ */ React.createElement(Grid, { container: true, spacing: 2, sx: { mb: 2 } }, /* @__PURE__ */ React.createElement(Grid, { item: true, xs: 12, sm: 6 }, /* @__PURE__ */ React.createElement(
    FormTextField,
    {
      key: `${path}.fileName`,
      label: "File Name",
  ...
  ))), /* @__PURE__ */ React.createElement(Box, { sx: { height: 500, width: "100%", mb: 2 } }, /* @__PURE__ */ React.createElement(
    DataGrid,
    {
      rows: gridRows,
      columns: gridColumns,
    ...
    /* @__PURE__ */ React.createElement(DialogTitle, null, "CSV Data for ", table.getFileName() || "data", ".csv"),
    ...
    /* @__PURE__ */ React.createElement(DialogActions, null, /* @__PURE__ */ React.createElement(Button, { onClick: () => setCsvDialogOpen(false) }, "Close"))
  ));
};
...
var DefaultEnumEditor = ({
  ...
  if (readonly) {
    if (!displayValue)
      return null;
    return /* @__PURE__ */ React.createElement(Box, { sx: { py: 0.5 } }, /* @__PURE__ */ React.createElement(Typography, { variant: "caption", color: "text.secondary", sx: { mr: 1 } }, fieldSchema.label, ":"), /* @__PURE__ */ React.createElement(Typography, { component: "span" }, displayValue));
  }
  return /* @__PURE__ */ React.createElement(FormControl, { variant: formVariant, sx: { mt: 2, width: "100%" } }, /* @__PURE__ */ React.createElement(InputLabel, null, fieldSchema.label), /* @__PURE__ */ React.createElement(
    Select,
    {
    ...
    Object.values(fieldSchema.schema?.enum || {}).map((option) => /* @__PURE__ */ React.createElement(MenuItem, { key: option.id, value: option.id }, option.label))
  ));
};
...
var DefaultEditor = ({
  ...
  const renderField = () => {
    ...
    if (fieldSchema.type === "object") {
      const content = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Box, { sx: { p: dense ? 0 : 1 } }, fieldName === "location" && /* @__PURE__ */ React.createElement(
      ...
      return useFieldset ? /* @__PURE__ */ React.createElement(Fieldset, { dense }, /* @__PURE__ */ React.createElement("legend", null, title || fieldSchema.label || fieldName), content) : content;
    }
...
var RouterProvider = ({ children }) => {
  ...
  const breadcrumbs = useMemo(() => generateBreadcrumbs(currentPath), [currentPath, dataset]);
  return /* @__PURE__ */ React.createElement(RouterContext.Provider, { value: { currentPath, navigateTo, goBack, breadcrumbs, canGoBack } }, children);
};
var useRouter = () => {
...
var Router = () => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ React.createElement(Box, { sx: {
      ...
      width: "100%",
      p: 3
    } }, /* @__PURE__ */ React.createElement(CircularProgress, { size: 40 }), /* @__PURE__ */ React.createElement(Typography, { sx: { mt: 2, mb: 1 }, variant: "h6" }, datasetName ? `Loading ${datasetName}...` : "Loading dataset..."), loadingMessage && /* @__PURE__ */ React.createElement(Typography, { variant: "body2", color: "text.secondary" }, loadingMessage));
  }
  if (!dataset) {
    return /* @__PURE__ */ React.createElement(Box, { sx: {
      display: "flex",
      ...
      width: "100%",
      p: 3
    } }, /* @__PURE__ */ React.createElement(Typography, { variant: "h6" }, "No dataset available"), /* @__PURE__ */ React.createElement(Typography, { variant: "body2", color: "text.secondary" }, "Please select a dataset to view"));
  }
  const match = findMatchingRoute(currentPath);
  if (!match) {
    return /* @__PURE__ */ React.createElement(Box, { sx: {
      ...
      p: 3,
      textAlign: "center"
    } }, /* @__PURE__ */ React.createElement(Typography, { variant: "h6", sx: { mb: 2 } }, "Path not found: ", currentPath), /* @__PURE__ */ React.createElement(Typography, null, "Please select an item from the navigation panel or try reloading the editor."));
  }
...
var AppBarBreadcrumbs = () => {
  ...
  return /* @__PURE__ */ React.createElement(Box$1, { sx: { display: "flex", alignItems: "center", flexGrow: 1 } }, /* @__PURE__ */ React.createElement(Tooltip, { title: "Go back" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(
    IconButton$1,
    {
      size: "small",
      onClick: goBack,
    ...
    /* @__PURE__ */ React.createElement(ArrowBackIcon, { fontSize: "small" })
  ))), /* @__PURE__ */ React.createElement(
    Breadcrumbs,
    {
      separator: /* @__PURE__ */ React.createElement(NavigateNextIcon, { fontSize: "small" }),
      "aria-label": "breadcrumb",
      sx: { flexGrow: 1 }
    },
    breadcrumbs.map((crumb, index) => /* @__PURE__ */ React.createElement(
      Typography6,
      {
        key: crumb.path,
        variant: "body1",
      ...
      index === 0 && /* @__PURE__ */ React.createElement(HomeIcon, { sx: { mr: 0.5 }, fontSize: "small" }),
      crumb.label
    ))
  ));
};
...
var TreeItem = ({
  ...
  const getIcon = () => {
    ...
    if (parts[0] === "dataset") {
      return /* @__PURE__ */ React.createElement(DescriptionIcon, null);
    }
    if (parts[0] === "paleoData") {
      if (parts.length >= 3 && parts[2] === "measurementTables") {
        return /* @__PURE__ */ React.createElement(TableChartIcon, null);
      }
      return /* @__PURE__ */ React.createElement(FolderIcon, null);
    }
    if (parts[0] === "publications") {
      return /* @__PURE__ */ React.createElement(ArticleIcon, null);
    }
    if (parts[0] === "chronData") {
      return /* @__PURE__ */ React.createElement(TableRowsIcon, null);
    }
    return /* @__PURE__ */ React.createElement(DescriptionIcon, null);
  };
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    hasChildren && /* @__PURE__ */ React.createElement(ListItemIcon, { onClick: handleToggle, sx: { minWidth: 24 } }, isExpanded ? /* @__PURE__ */ React.createElement(ExpandMoreIcon, null) : /* @__PURE__ */ React.createElement(ChevronRightIcon, null)),
    !hasChildren && /* @__PURE__ */ React.createElement(ListItemIcon, { sx: { minWidth: 24 } }, getIcon()),
    /* @__PURE__ */ React.createElement(ListItemText, { primary: safeLabel })
  );
};
...
var ChronDataTree = ({ dataset }) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, { key: chronNodeId }, /* @__PURE__ */ React.createElement(
      TreeItem_default,
      {
        node: chronData,
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, { key: tableNodeId }, /* @__PURE__ */ React.createElement(
        TreeItem_default,
        {
          node: table,
...
var ConfirmDialog = ({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(DialogTitle, { id: "confirm-dialog-title" }, title),
    /* @__PURE__ */ React.createElement(DialogContent, null, /* @__PURE__ */ React.createElement(DialogContentText, { id: "confirm-dialog-description" }, message)),
    /* @__PURE__ */ React.createElement(DialogActions, null, /* @__PURE__ */ React.createElement(Button3, { onClick: onCancel, color: "primary" }, "Cancel"), /* @__PURE__ */ React.createElement(Button3, { onClick: onConfirm, color: "primary", variant: "contained", autoFocus: true }, "Confirm"))
  );
};
var ConfirmDialog_default = ConfirmDialog;
var EditorPanel = () => {
  return /* @__PURE__ */ React.createElement(Box, { sx: { px: 2, py: 1 } }, /* @__PURE__ */ React.createElement(Router, null));
};
var NavigationPanel = () => {
  ...
  if (!dataset) {
    return /* @__PURE__ */ React.createElement(Box, { sx: { p: 2, textAlign: "center" } }, /* @__PURE__ */ React.createElement(CircularProgress, null));
  }
  ...
  const renderPaleoDataTree = () => {
    return /* @__PURE__ */ React.createElement(TreeItem$1, { itemId: "dataset.paleoData", label: "PaleoData" }, workingDataset.getPaleoData()?.map((paleoData, paleoIndex) => {
      const paleoNodeId = `dataset.paleoData.${paleoIndex}`;
      return /* @__PURE__ */ React.createElement(TreeItem$1, { key: paleoNodeId, itemId: paleoNodeId, label: paleoData.getName() || `PaleoData ${paleoIndex + 1}` }, paleoData.getMeasurementTables()?.map((table, tableIndex) => {
  ...
  const renderChronDataTree = () => {
    return /* @__PURE__ */ React.createElement(TreeItem$1, { itemId: "dataset.chronData", label: "ChronData" }, workingDataset.getChronData()?.map((chronData, chronIndex) => {
      const chronNodeId = `dataset.chronData.${chronIndex}`;
      return /* @__PURE__ */ React.createElement(TreeItem$1, { key: chronNodeId, itemId: chronNodeId, label: `ChronData ${chronIndex + 1}` }, chronData.getMeasurementTables()?.map((table, tableIndex) => {
  ...
  const renderPublicationsTree = () => {
    return /* @__PURE__ */ React.createElement(TreeItem$1, { itemId: "dataset.publications", label: "Publications" }, workingDataset.getPublications()?.map((publication, index) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { sx: { p: 2 } }, /* @__PURE__ */ React.createElement(
    SimpleTreeView,
    {
    ...
    /* @__PURE__ */ React.createElement(TreeItem$1, { itemId: "dataset", label: "Dataset" }, /* @__PURE__ */ React.createElement(
      TreeItem$1,
      {
        itemId: "dataset.location",
        label: "Location"
      }
    ), renderPaleoDataTree(), renderChronDataTree(), renderPublicationsTree(), /* @__PURE__ */ React.createElement(
      TreeItem$1,
      {
...
var PaleoDataTree = ({ dataset }) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, { key: paleoNodeId }, /* @__PURE__ */ React.createElement(
      TreeItem_default,
      {
        node: paleoData,
...
var SyncProgressBar = () => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Typography, { variant: "subtitle1", sx: { mb: 1 } }, "Syncing to GraphDB..."),
    /* @__PURE__ */ React.createElement(
      LinearProgress,
      {
        variant: "determinate",
    ...
    /* @__PURE__ */ React.createElement(Typography, { variant: "caption", sx: { mt: 1 } }, syncProgress, "% Complete")
  );
};
...
var LiPDApp = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Box, { sx: { px: 2, py: 1 } }, /* @__PURE__ */ React.createElement(AppBarBreadcrumbs_default, null)), /* @__PURE__ */ React.createElement(Divider, null), /* @__PURE__ */ React.createElement(Box, { sx: { display: "flex", height: "100%" } }, /* @__PURE__ */ React.createElement(Box, { sx: {
    width: 300,
    flexShrink: 0,
    borderRight: 1,
    borderColor: "divider",
    overflow: "auto"
  } }, /* @__PURE__ */ React.createElement(NavigationPanel, null)), /* @__PURE__ */ React.createElement(Box, { sx: {
    flex: 1,
    overflow: "auto",
    p: 2
  } }, /* @__PURE__ */ React.createElement(Router, null))), /* @__PURE__ */ React.createElement(
...
export { AddIcon, AppBarActions_default as AppBarActions, AppBarBreadcrumbs_default as AppBarBreadcrumbs, ArrowBackIcon, ArticleIcon, CheckIcon, ChevronRightIcon, ChronDataTree_default as ChronDataTree, ConfirmDialog_default as ConfirmDialog, DataTableEditor, DefaultEditor, DefaultEnumEditor, DefaultListEditor, DeleteIcon, DescriptionIcon, EditIcon, EditorPanel, ExpandMoreIcon, Fieldset, FileDownloadIcon, FileUploadIcon, FolderIcon, FormTextField, HomeIcon, LiPDApp, ListView_default as ListView, NavigateNextIcon, NavigationPanel, PaleoDataTree_default as PaleoDataTree, PublicationsTree_default as PublicationsTree, RedoIcon, Router, RouterProvider, SaveAsIcon, SaveIcon, SyncIcon, SyncProgressBar_default as SyncProgressBar, TableChartIcon, TableRowsIcon, TreeItem_default as TreeItem, UndoIcon, archiveTypeSchema, calibrationSchema, changeLogEntrySchema, changeLogSchema, compilationSchema, dataSchema, dataTableSchema, datasetSchema, fundingSchema, getChangeLogCuratorLabel, getChangeLogEntryLabel, getChangeLogLabel, getCompilationNameLabel, getDataDetailsLabel, getDataTableLabel, getDataTableVariablesLabel, getFundingGrantsLabel, getFundingLabel, getMeasurementTablesLabel, getModeledByLabel, getPersonNameLabel, getPublicationAuthorsLabel, getPublicationFullLabel, getPublicationTitleLabel, getSchemaForPath, getVariableDescriptionLabel, getVariableNameLabel, getVariableUnitsLabel, interpretationSchema, interpretationVariableSchema, locationSchema, modelSchema, paleoUnitSchema, paleoVariableSchema, personSchema, proxyGeneralSchema, proxySchema, publicationSchema, resolutionSchema, seasonalityGeneralSchema, seasonalityOriginalSchema, seasonalitySchema, useLiPDStore, useRouter, variableSchema };
